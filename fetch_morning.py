#!/usr/bin/env python3
"""
市场早盘报告 v3 — 美股收盘 + 亚太开盘 + 商品外汇 + 重大新闻
运行时机：市场开盘前 8:00-8:45 AM

数据源：
  美股三大指数:  Sina (index_us_stock_sina)
  市场/港股指数:   Sina 实时 (hq.sinajs.cn)
...
修复记录:
  v3: 期货代码GC/CL/CN+非NaN过滤, 日经使用int_nikkei, 市场使用Sinajs
  v2: 多源架构, yfinance备选
  v1: 初始版本
"""
...
print("=" * 60)
print(f"📊 市场早盘数据采集 v3 — {TODAY_STR} {report['weekday']}")
print("=" * 60)
